...
In our own teaching,
we sometimes skip the section on logic programming (section 4.4), % fixme
we have students use the register-machine simulator
but we do not cover its implementation (section 5.2), % fixme
and we give only a cursory overview of the compiler (section 5.5). %fixme
...
The World-Wide-Web site www-mitpress.mit.edu/sicp % fixme
